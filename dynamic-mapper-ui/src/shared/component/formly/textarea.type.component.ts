    ...
    @if (props['sensitive']) {
      <div style="position: relative;">
        <textarea
          ...
          [style.-webkit-text-security]="showSensitive ? 'none' : 'disc'"
          [style.color]="showSensitive ? null : 'transparent'"
          [style.text-shadow]="showSensitive ? null : '0 0 8px rgba(0,0,0,0.5)'"
          #textareaRef
        >
 {{ formControl.value }}
</textarea>
