...
export enum Operation {
  ...
  RESET_STATISTICS_MAPPING = 'RESET_STATISTICS_MAPPING',
  ...
  COPY_SNOOPED_SOURCE_TEMPLATE = 'COPY_SNOOPED_SOURCE_TEMPLATE',
  INIT_CODE_TEMPLATES = 'INIT_CODE_TEMPLATES',
  ADD_SAMPLE_MAPPINGS = 'ADD_SAMPLE_MAPPINGS',
  CLEAR_CACHE_DEVICE_TO_CLIENT = 'CLEAR_CACHE_DEVICE_TO_CLIENT',
}
