    ...
    <div class="d-col flex-nowrap no-align-items p-48 flex-grow col-md-12 col-md-offset-0 c8y-stepper--no-btns">
      <div class="card card--fullpage d-col flex-grow">
          ...
          <div class="card-block">
            ...
            <c8y-list-group class="separator-top m-t-24" role="list">
              ...
              <c8y-li role="listitem">
                <c8y-li-radio name="subscriptionChoice" [value]="'skip'" [(ngModel)]="choice" [attr.data-cy]="'dm-subscription-choice-skip'"></c8y-li-radio>
              ...
              <!-- By device type -->
              <c8y-li role="listitem">
                <c8y-li-radio name="subscriptionChoice" [value]="'type'" [(ngModel)]="choice" [attr.data-cy]="'dm-subscription-choice-type'"></c8y-li-radio>
              ...
              <!-- By device group -->
              <c8y-li role="listitem">
                <c8y-li-radio name="subscriptionChoice" [value]="'group'" [(ngModel)]="choice" [attr.data-cy]="'dm-subscription-choice-group'"></c8y-li-radio>
                      ...
                      @for (g of deviceGroups; track g.id) {
                        <c8y-li [dense]="true" role="listitem">
                          <c8y-li-radio name="groupChoice" [value]="g.id"
                            [attr.data-cy]="'dm-subscription-choice-group-' + g.id"
        ...
        <div class="card-footer separator p-24 text-center flex-no-shrink">
            <button class="btn btn-default" [attr.data-cy]="'dm-subscription-choice-cancel'" (click)="onCancel()" translate>Cancel</button>
            <button class="btn btn-primary m-l-8"
            [attr.data-cy]="'dm-subscription-choice-confirm'"
