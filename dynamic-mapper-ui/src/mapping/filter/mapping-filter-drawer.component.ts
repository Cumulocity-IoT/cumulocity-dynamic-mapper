...
@Component({
  selector: 'd11r-mapping-filter-drawer',
  templateUrl: './mapping-filter-drawer.component.html',
  styleUrls: ['../shared/mapping.style.css'],
  encapsulation: ViewEncapsulation.None,
  standalone: true,
  imports: [CoreModule, SharedModule, JsonEditorComponent]
})
export class MappingFilterDrawerComponent implements OnInit, OnDestroy, AfterViewInit {
