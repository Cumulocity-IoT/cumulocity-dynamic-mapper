...
This documentation is organised in three tiers, so you only read what you need at the time.
...
Further reading outside this documentation:

- The [Dynamic Mapper repository](https://github.com/Cumulocity-IoT/cumulocity-dynamic-mapper) on GitHub.
- [JSONata](https://jsonata.org/), the query and transformation language used for mapping expressions.
- The [Cumulocity domain model](https://cumulocity.com/docs/concepts/domain-model/), which is what mappings
  produce.
