...
public class ProcessorExtensionSparkplugBWithConfigMeasurement implements ProcessorExtensionInbound<byte[]> {
    ...
    @Generated
    private static final Logger log = LoggerFactory.getLogger(ProcessorExtensionSparkplugBWithConfigMeasurement.class);
    ...
    public ProcessorExtensionSparkplugBWithConfigMeasurement() {
    }
