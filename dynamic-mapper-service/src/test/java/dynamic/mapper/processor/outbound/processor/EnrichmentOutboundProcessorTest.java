...
class EnrichmentOutboundProcessorTest {
    ...
    void testAllowedHostClasses() throws Exception {
        ...
        // NOTE: GraalVM Engine cannot be properly mocked due to internal state
        // requirements
    ...
    void testProcessWithDefaultTransformation() throws Exception {
        ...
        verify(graalVMContextService, never()).peekGraalEngine(anyString());
    ...
    void testGraalContextBuilderReuse() throws Exception {
        ...
        verify(graalVMContextService, times(2)).peekGraalEngine(TEST_TENANT);
