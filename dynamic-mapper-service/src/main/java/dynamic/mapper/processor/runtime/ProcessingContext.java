...
public class ProcessingContext<O> implements AutoCloseable {
     ...
     *
     * <p><b>Read-only projection:</b> there is no {@code syncFromDeviceContext(...)}
     * method and deliberately so — {@link ProcessingContext} remains the single mutable
     * owner of this state. {@link DeviceContext} is immutable
