...
public class FlowSubstitutionInboundProcessor extends BaseProcessor {
    ...
    private void processCumulocityMessage(CumulocityMessage cumulocityMessage, ProcessingContext<?> context,
        ...
        try {
            ...
            C8YRequest c8yRequest = createC8YRequest(payloadJson, targetAPI, cumulocityMessage.getAction(), resolvedDeviceId);
    ...
    private C8YRequest createC8YRequest(String payloadJson, API targetAPI, String action, String sourceId) throws ProcessingException {
        try {
            ...
            C8YRequest c8yRequest = C8YRequest.builder()
                    .method(method)
                    .api(targetAPI)
                    .targetAPI(targetAPI)
                    .sourceId(sourceId)
