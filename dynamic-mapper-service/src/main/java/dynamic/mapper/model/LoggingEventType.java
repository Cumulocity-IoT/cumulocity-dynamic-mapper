...
public enum LoggingEventType {
    SUBSCRIPTION_EVENT_TYPE("SUBSCRIPTION_EVENT_TYPE", "d11r_subscriptionEvent", "d11r_subscription",
    ...
    MAPPING_CREATED_EVENT_TYPE("MAPPING_CREATED_EVENT_TYPE", "d11r_mappingCreatedEvent", "d11r_mapping",
            "Mapping", "info", "A mapping was created"),
    MAPPING_UPDATED_EVENT_TYPE("MAPPING_UPDATED_EVENT_TYPE", "d11r_mappingUpdatedEvent", "d11r_mapping",
            "Mapping", "info", "A mapping's configuration, filter, code, or debug flag was updated"),
    MAPPING_DELETED_EVENT_TYPE("MAPPING_DELETED_EVENT_TYPE", "d11r_mappingDeletedEvent", "d11r_mapping",
            "Mapping", "info", "A mapping was deleted"),
    MAPPING_ACTIVATION_EVENT_TYPE("MAPPING_ACTIVATION_EVENT_TYPE", "d11r_mappingActivationEvent", "d11r_mapping",
            "Mapping", "info", "A mapping was activated or deactivated"),
    MAPPING_CHANGED_EVENT_TYPE("MAPPING_CHANGED_EVENT_TYPE", "d11r_mappingChangedEvent", "d11r_mapping",
            "Mapping", "info", "Bulk/batch mapping configuration change notifications not tied to a single mapping"),
    ...
    NOTIFICATION_EVENT_TYPE("NOTIFICATION_EVENT_TYPE", "d11r_notificationStatusEvent", "d11r_notification",
            "Connector", "warning", "Notification connector status events"),
    SUBSCRIPTION_DEDUPLICATION_EVENT_TYPE("SUBSCRIPTION_DEDUPLICATION_EVENT_TYPE", "d11r_subscriptionDeduplicationEvent", "d11r_subscriptionDeduplication",
