...
public class MQTTClient extends AConnectorClient {
    public MQTTClient() {
        ...
        configProps.put("protocol",
                new ConnectorProperty(true, 0, ConnectorPropertyType.OPTION_PROPERTY, true, true, "mqtt://", Map.ofEntries(
        ...
        configProps.put("mqttHost",
                new ConnectorProperty(true, 1, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
        configProps.put("mqttPort",
                new ConnectorProperty(true, 2, ConnectorPropertyType.NUMERIC_PROPERTY, true, true, null, null));
        configProps.put("user",
                new ConnectorProperty(false, 3, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
        configProps.put("password",
                new ConnectorProperty(false, 4, ConnectorPropertyType.SENSITIVE_STRING_PROPERTY, true, true, null, null));
        configProps.put("clientId",
                new ConnectorProperty(true, 5, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
        configProps.put("useSelfSignedCertificate",
                new ConnectorProperty(false, 6, ConnectorPropertyType.BOOLEAN_PROPERTY, true, true, null, null));
        configProps.put("fingerprintSelfSignedCertificate",
                new ConnectorProperty(false, 7, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
        configProps.put("nameCertificate",
                new ConnectorProperty(false, 8, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
        configProps.put("supportsWildcardInTopic",
                new ConnectorProperty(false, 9, ConnectorPropertyType.BOOLEAN_PROPERTY, true, true, true, null));
        configProps.put("serverPath",
                new ConnectorProperty(false, 10, ConnectorPropertyType.STRING_PROPERTY, true, true, null, null));
