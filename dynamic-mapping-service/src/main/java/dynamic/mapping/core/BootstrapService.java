    ...
    public void initialize(MicroserviceSubscriptionAddedEvent event) {
        ...
        try {
            ...
            if (serviceConfiguration != null) {
                ...
                ConnectorConfiguration httpClientConfiguration = null;
                ...
                for (ConnectorConfiguration connectorConfiguration : connectorConfigurationList) {
                    initializeConnectorByConfiguration(connectorConfiguration, serviceConfiguration,
                            tenant);
                    if (ConnectorType.HTTP.equals(connectorConfiguration.connectorType)) {
                        httpClientConfiguration = connectorConfiguration;
                    }
                }
