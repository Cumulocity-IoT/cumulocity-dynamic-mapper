#!/usr/bin/env bash
# build.sh — builds and packages the http-polling-mock microservice as a Cumulocity ZIP.
#
# Usage:
#   ./build.sh [--push]
#
...
#
# Output:  http-polling-mock.zip  (in the current directory)
set -euo pipefail

IMAGE_NAME="http-polling-mock"
