...
| [**getCodeTemplate**](ConfigurationControllerApi.md#getCodeTemplate) | **GET** /configuration/code/{id} | Liefert ein Code-Template |
...
| [**getServiceConfiguration**](ConfigurationControllerApi.md#getServiceConfiguration) | **GET** /configuration/service | Liefert die Service-Konfiguration |
...
| [**updateServiceConfiguration**](ConfigurationControllerApi.md#updateServiceConfiguration) | **PUT** /configuration/service | Aktualisiert die Service-Konfiguration |
...
Create a new connector configuration
    ...
    Creates a new connector configuration for the specified type.
...
Delete a connector configuration
    ...
    Deletes the connector configuration for the given ID.
...
Liefert ein Code-Template

    Gibt das Code-Template für die angegebene ID zurück.
...
Liefert die Service-Konfiguration

    Gibt die Service-Konfiguration des aktuellen Tenants zurück.
...
Update a connector configuration
    ...
    Updates the connector configuration for the given ID.
...
|------------- | ------------- | ------------- | -------------|
| **identifier** | **String**|  | [default to null] |
| **ConnectorConfiguration** | [**ConnectorConfiguration**](../Models/ConnectorConfiguration.md)|  | |
...
Aktualisiert die Service-Konfiguration
    ...
    Aktualisiert die Service-Konfiguration des aktuellen Tenants.
