...
import { API, Mapping, MappingSubstitution, QOS, RepairStrategy, SnoopStatus, ValidationError,LINK_DIRECT, UPLINK_API_OPTION, DOWNLINK_API_OPTION } from "../../shared/configuration.model";
